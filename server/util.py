...
def classify_image(image_base64_data, file_path=None):
    ...
    for img in imgs:
        ...
        result.append({
            ...
            'class_probability': np.round(__model.predict_proba(final)*100,0).tolist()[0],
...
if __name__ == '__main__':
    ...
    # print(classify_image(None, "./test_images/ronaldo1.jpg"))
    # print(classify_image(None, "./test_images/ronaldo2.jpg"))
    # print(classify_image(None, "./test_images/ramos1.jpg"))
    # print(classify_image(None, "./test_images/neymar1.jpg"))
